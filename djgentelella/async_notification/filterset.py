...
from djgentelella.async_notification.models import NewsLetter, NewsLetterTemplate, \
    EmailTemplate, NewsLetterTask
...
class NewsletterTemplateFilterSet(FilterSet):
    ...
    class Meta:
        ...
        fields = {'title': ['icontains'], "slug": ["icontains"], "model_base": ["icontains"]}
