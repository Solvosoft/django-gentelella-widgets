...
try:
    ...
    def send_email_task(self, notification_pk):
        ...
        # Deferred: the worker imports this module at startup, before the app
        # registry is ready, and sending pulls in the models.
        from djgentelella.async_notification.sending import (  # noqa: PLC0415
