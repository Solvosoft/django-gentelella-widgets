...
function get_select2box(instance){
    ...
    'insert_api_data': function(current_instance, value_dictionary){
                        console.log("value_dictionary--------- "+value_dictionary)
                        ...
                        console.log("temp_ref---- "+temp_ref)
                        console.log("temp_ref_selected------ "+temp_ref_selected)
    ...
    'create_custom_form': function(url, current_instance) {
      ...
      //FUNCION QUE ENVIA LOS DATOS DE LA PERSONA QUE SE CREA EN EL MODAL
                        ...
                        fetch(url, { method: "POST", credentials: 'include',
                          ...
                          body: formDataJsonString
                            ...
                            try{
                                ...
                                this.send_selected_data(current_instance);
                            }catch(error){
                                alert(data['error'])
                            }
                          }).catch(error => {
