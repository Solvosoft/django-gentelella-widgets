...
class ScreenshotSeleniumTest(StaticLiveServerTestCase):
    ...
    def screenShots(self, name, url):
        ...
        for resolution in self.resolutions:
            ...
            print("Window size: width = {}px, height = {}px".format(resolution['width'],
                                                                    resolution[
                                                                        'height']))
            ...
            self.folder = '%s/%dx%d' % (
                self.tmp, resolution['width'], resolution['height'])
            ...
            self.selenium.save_screenshot(
                str(Path(self.dir / x_Page).absolute().resolve()))
            self.selenium.save_full_page_screenshot(
